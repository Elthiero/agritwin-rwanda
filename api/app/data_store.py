...
class DataStore:
    ...
    def load(self) -> None:
        ...
        geojson_path = (
            get_settings().DATA_DIR / "public" / "geo" / "rwanda_districts_simplified.geojson"
        )
    ...
    def district_name(self, district_code: int) -> str | None:
        """NISR district_code -> name, from the boundary features' district_code
        property (already joined at export time by src/agritwin/export/geo.py)."""
