...
5. ~~`models/scenario.py`~~ — done this session. *Tech innovation.* The `GET /scenario/{code}` endpoint is now the smallest next step to actually surface it.
