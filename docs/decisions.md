...
- **Reason:** Survey methodologist review (2026-09-23) verified both designs are unbiased for point estimates but produce different variance structures. **Critical risk:** naive pooling using a single PSU bootstrap will underestimate variance in 2020+ because it ignores within-segment plot-level weight variation. Individual verification of 2020–2025: 2020 77.8%, 2021 76.9%, 2022 76.0%, 2023 76.4%, 2025 ~76% of segments show weight variation across plots, vs 1.6% of 2019 segments. This creates false precision: confidence intervals will be narrower than they should be, risking overconfident policy recommendations. Stratified design preserves 24k plots from 2019 (both seasons) for robust attainable-yield percentiles while respecting each year-block's actual design.
